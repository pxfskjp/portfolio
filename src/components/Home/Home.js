          ...
          <Row>
            <Col md={7} className="home-header">
              ...
              <h1 className="heading-name">
                I'M
                <strong className="main-name"> Nan GuoXing</strong>
              </h1>
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links w-50">
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/nan-guoxing-0729"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/nan-guoxing-0729/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/nan-guoxing-0729/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
